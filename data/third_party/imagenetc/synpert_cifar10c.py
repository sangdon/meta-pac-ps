...
def frost(x, severity=1):
    ...
    filename = [os.path.join(FILEDIR, 'frost1.png'),
                os.path.join(FILEDIR, 'frost2.png'),
                os.path.join(FILEDIR, 'frost3.png'),
                os.path.join(FILEDIR, 'frost4.jpg'),
                os.path.join(FILEDIR, 'frost5.jpg'),
                os.path.join(FILEDIR, 'frost6.jpg')][idx]
